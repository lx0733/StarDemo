...
public class Tbk implements Serializable{
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 3; i++) {
			Tbk tbk = new Tbk();
			final int c = i;
			Thread thread = new Thread(() -> tbk.testSync(c));
			thread.start();
		}
